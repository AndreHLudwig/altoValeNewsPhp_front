...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        document.getElementById("publicationForm").addEventListener("submit", function (event) {
            ...
            Promise.all([
                imagemFile ? fileToBase64(imagemFile) : Promise.resolve(null),
                videoFile ? fileToBase64(videoFile) : Promise.resolve(null)
                ...
                fetch('http://localhost:8080/publicacao', {
                    ...
                    .then(data => {
                        if (data && data.publicacaoId) {
                            ...
                            // Limpar campos do formulário ou redirecionar após sucesso
